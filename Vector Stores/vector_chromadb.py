...
# Change 'embedding' -> 'embeddings'
data = vector_store.get(include=['embeddings', 'documents', 'metadatas'])

# If you want to actually see what's inside, you should print it:
print(data)
